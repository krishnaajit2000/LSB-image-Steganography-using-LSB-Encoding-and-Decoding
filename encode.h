...
{
    /* Source Image info */
    char *src_image_fname;  //store beautiful.bmp
    FILE *fptr_src_image;    //file address of beaut.bmp file
    uint image_capacity;      //stores bmp file size
    uint bits_per_pixel;
    char image_data[MAX_IMAGE_BUF_SIZE];

    /* Secret File Info */
    char *secret_fname;       //store secrete.txt
    FILE *fptr_secret;         //store file address of secrt.txt file
